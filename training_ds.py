...
test_img = '/home/hongyi/py_ws/CovidCount/mall_dataset/cropped_images/999.jpg'
...
data_folder='/home/hongyi/py_ws/CovidCount/mall_dataset'
class_num = 10
batch_size = 8
...
model.compile(optimizer = tf.keras.optimizers.Adam(learning_rate=0.00001),
              ...
              metrics=['mae'])
model.fit(x=train_ds, validation_data=validation_ds, steps_per_epoch=875, 
